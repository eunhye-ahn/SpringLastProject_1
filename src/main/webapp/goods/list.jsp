			...
			<div class="col-md-3">
			    <div class="thumbnail">
			      <a href="../goods/detail_before.do?no=${vo.no }">
			        <img src="${vo.goods_poster }" title="${vo.goods_price}" style="width:100%">
			        <div class="caption">
			          <p>${vo.goods_name}</p>
			        </div>
			      </a>
	...
	<div class="row text-center" style="margin-top:10px">
		<ul class="pagination">
			...
			<c:forEach var="i" begin="${startpage }" end="${endpage }">
				<li class="${i==curpage ? 'active':'' }"><a href="../goods/list.do?page=${i }">${i }</a></li>
			</c:forEach>
			...
			<c:forEach var="cvo" items="${cList }">
				<div style="width:100px;height:100px;display:inline-block;">
				      <a href="../goods/detail_before.do?no=${cvo.no }">
				        <img src="${cvo.goods_poster }" style="width:100%">
				      </a>
				 </div>
			</c:forEach>
		</c:if>
